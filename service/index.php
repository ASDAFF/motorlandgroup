...
$img = CFile::ResizeImageGet(905, array('width'=>310, 'height'=>210), BX_RESIZE_IMAGE_EXACT, true)['src'];
$img2 = CFile::ResizeImageGet(905, array('width'=>520, 'height'=>360), BX_RESIZE_IMAGE_EXACT, true)['src'];
            ...
            <li class="ser-menu">
                ...
                <div class="service-menu-sub">
                    ...
                    <div class="service-one-articles category">
                        ...
                        <ul>
                            <li><img src="<?=CFile::ResizeImageGet(905, array('width'=>520, 'height'=>360), BX_RESIZE_IMAGE_EXACT, true)['src']?>"></li>
                            <li><a href="#">Подробнее...</a></li>
