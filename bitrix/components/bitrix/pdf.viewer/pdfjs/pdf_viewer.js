...
/******/ ([
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		function configure(PDFJS) {
			...
			PDFJS.workerSrc = window.pdfJsPathToWorker;
		...
		var PDFViewerApplication = {
			...
			get loadingBar() {
				var bar = new _ui_utils.ProgressBar('#loadingBar' + window.pdfJsViewerId, {});
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		function renderProgress(index, total) {
			var progressContainer = document.getElementById('printServiceOverlay' + window.pdfJsViewerId);
		...
		function ensureOverlay() {
			if (!overlayPromise) {
				overlayPromise = _overlay_manager.OverlayManager.register('printServiceOverlay', document.getElementById('printServiceOverlay' + window.pdfJsViewerId), abort, true);
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		var PasswordPrompt = function () {
			function PasswordPrompt(options) {
				...
				if(!_overlay_manager.OverlayManager.overlays[this.overlayName])
				{
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		function getViewerConfiguration(viewerId) {
			return {
				...
				secondaryToolbar: {
					...
					toggleHandToolButton: document.getElementById('toggleHandTool' + viewerId),
				...
				documentProperties: {
					overlayName: 'documentPropertiesOverlay' + viewerId,
		...
		document.addEventListener('PdfJsChangeSource', webViewerLoad, true);
		/***/ })
	/******/ ]);
