...
class CDiskPdfComponent extends \CBitrixComponent
{
	...
	public function executeComponent()
	{
		...
		$this->arResult['CSS_FILES'] = array($this->__path.'/pdfjs/viewer.css',);
		$this->arResult['JS_FILES'] = array($this->__path.'/pdfjs/pdf.js', $this->__path.'/pdfjs/l10n.js', $this->__path.'/pdfjs/pdf_viewer.js');
		$this->arResult['LOCALE_FILES'] = $this->__path.'/pdfjs/locale/locale.properties';
		$this->arResult['PATH_TO_WORKER'] = $this->__path.'/pdfjs/pdf.worker.js';
