...
<head>
    ...
    <link href="<?=SITE_TEMPLATE_PATH?>/css/model.css" type="text/css"  rel="stylesheet" />
    ...
    <link rel="stylesheet" href="<?=SITE_TEMPLATE_PATH?>/css/new_styles.css">
    ...
    <!--<![endif]-->
    <script src="<?=SITE_TEMPLATE_PATH?>/js/w-modal.js"></script>
    <script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/js/model.js"></script>
